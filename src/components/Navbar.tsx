...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-0 top-16 z-40 bg-white/95 dark:bg-[#090a0f]/95 backdrop-blur-lg border-b border-zinc-200 dark:border-white/[0.08] flex flex-col px-6 py-8 md:hidden transition-opacity"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="mt-auto pt-8 border-t border-zinc-200 dark:border-white/[0.08] flex flex-col gap-4">
